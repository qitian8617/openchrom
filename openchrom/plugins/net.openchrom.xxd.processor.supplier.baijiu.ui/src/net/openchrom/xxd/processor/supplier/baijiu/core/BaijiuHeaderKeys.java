...
public final class BaijiuHeaderKeys {

	public static final String SAMPLE_NO = "Baijiu Sample No";
	public static final String LIQUOR_NAME = "Baijiu Liquor Name";
	public static final String AROMA = "Baijiu Aroma";
	public static final String ABV = "Baijiu ABV %vol";

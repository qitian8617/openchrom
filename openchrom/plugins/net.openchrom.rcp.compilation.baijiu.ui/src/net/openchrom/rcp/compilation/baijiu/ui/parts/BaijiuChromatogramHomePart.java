 ...
 * hint immediately. Opening a CSD selects ChromatogramEditorCSD in this
 * PartStack (e4 child, not a stolen {@code setParent} widget). The Area
 * placeholder is kept unrendered so cold start does not flash nested empty
 * editor frames.
 */
